...
with open("BTCUSDT_1D_test.json", "r") as f:
...
# Alinear fechas y definir n_days
df_test = df_test[df_test.index >= df_test.index[0]]
n_days = len(df_test)

# === 3. Simulación de trayectorias futuras ===
n_simulations = 100
