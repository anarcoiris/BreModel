...
file_path = "XMRUSDT_1D_binance.json"
...
top_points = sorted(density_info, key=lambda x: x["score"], reverse=True)[:3]
...
plt.title("Simulación con 3 Nodos de Convergencia de Trayectorias")
plt.xlabel("Fecha")
plt.ylabel("Precio (USD)")
plt.legend()
plt.grid(True)
